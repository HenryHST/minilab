...
| termix | `apps/termix/` | `termix` | `termix.stadthagen.dev` ([Termix](https://github.com/Termix-SSH/Termix) 2.7.1 + guacd, hostPath `/var/lib/termix` on `worker=true`, Port 8080) |
